...
const NavBar = () => {
  ...
  return (
    <div className="flex flex-col bg-red-400">
      <p className="bg-[#83A2FF] p-2 text-center text-white lg:block hidden">
        Get free delivery on orders over ₹300
      </p>
      <div className="bg-white shadow-md">
        <div className="max-w-6xl mx-auto p-4 flex items-center justify-between">
          <VscThreeBars className="lg:hidden sm:block" />
          <p
          ...
          <div className="flex items-center gap-5 font-medium cursor-pointer">
            ...
            <div className="flex items-center gap-4">
              ...
              <span>
                ...
                <div className="absolute bg-gray-200 w-3 px-3 flex justify-center items-center rounded-full lg:top-11 lg:right-28 top-0 right-2 ">
                  1
                </div>
              </span>
            </div>
